...
Thanks for using rmotis! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/e-kotov/rmotis/issues/new).
...
requests](https://github.com/e-kotov/rmotis/issues) to make sure the bug
